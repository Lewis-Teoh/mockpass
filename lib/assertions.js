...
const oidc = {
  ...
  corpPass: [
    ...
    {
      nric: 'F1234567N',
      uuid: 'c1d2e3f4-aaaa-4bcc-9def-000000000001',
      name: 'Foreign Entity Admin',
      isSingPassHolder: false,
      nonUen: {
        country: 'US',
        regNo: 'US-REG-99887766',
        name: 'Globex Foreign Corp',
      },
    },
  ],
  create: {
    ...
    corpPass: async (
      { nric, uuid, name, isSingPassHolder, uen, nonUen },
      iss,
      aud,
      nonce,
    ) => {
      ...
      const sub = `s=${nric},uuid=${uuid},u=${uen ?? nonUen?.regNo ?? ''}${nric},c=SG`
        ...
        idTokenClaims: {
          ...
          entityInfo: nonUen
            ? {
                ...
                CPEnt_TYPE: 'NON-UEN',
                CPEnt_Status: '',
                CPNonUEN_Country: nonUen.country,
                CPNonUEN_RegNo: nonUen.regNo,
                CPNonUEN_Name: nonUen.name,
              }
            : {
                CPEntID: uen,
                CPEnt_TYPE: 'UEN',
